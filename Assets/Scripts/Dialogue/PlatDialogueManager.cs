...
public class PlatDialogueManager : MonoBehaviour
{
    [Header("Dialogue UI")]
    ...
    [SerializeField] private MovementAnim movementAnim;
    ...
    private static PlatDialogueManager instance;
    public Story currentStory;
    public bool dialogueIsPlaying { get; private set; }
    private bool canContinueToNextLine = false;

    private bool dialogueRan = true;
    ...
    public static PlatDialogueManager GetInstance()
    {
        return instance;
    }
    ...
    public void EnterDialogueMode(TextAsset inkJSON)
    {
        ...
        {
            dialogueRan = false;
            bubbles[bubbleX].SetActive(false);
            bubbleX = bubbleX + 1;
        }
        ContinueStory();
    }
